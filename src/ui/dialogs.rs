...
pub fn draw_help(f: &mut Frame, app: &App) {
    ...
    let text = vec![
        ...
        help_line("    \u{2191}/\u{2193} or j/k", "Navigate tasks", key, desc),
        help_line("    \u{2190}/\u{2192} or h/l", "Switch lane", key, desc),
        help_line("    Tab / Shift+Tab", "Next / previous lane", key, desc),
        help_line("    H / L", "Move task between lanes", key, desc),
        help_line("    Enter", "Open task details", key, desc),
        help_line("    Space", "Mark done / undo done", key, desc),
        ...
        help_line("    n", "New task", key, desc),
        help_line("    e", "Edit selected task", key, desc),
        help_line("    d", "Delete selected task", key, desc),
